...
namespace AkkaNetDemo.Messages
{
    ...
    /// <summary>
    /// </summary>
    public class c4 : AbstractTrade
    {
        public c4(string ticker, int shares, TradeType tradeTradeType, TradeStatus tradeStatus, Guid tadingSessionId,
    ...
    public class inputt 
    {
        ...
        public inputt(string v1, int v2, TradeType buy, DateTime now)
        {
            this.v1 = v1;
            this.v2 = v2;
            this.buy = buy;
